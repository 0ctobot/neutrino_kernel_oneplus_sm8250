...
static struct kobj_attribute second_f_camera_attribute =
	__ATTR(second_f_camera, 0444, component_info_get, NULL);
...
static struct kobj_attribute forth_r_camera_attribute =
	__ATTR(forth_r_camera, 0444, component_info_get, NULL);
...
static struct kobj_attribute wireless_charge_attribute =
	__ATTR(wireless_charge, 0444, component_info_get, NULL);
...
struct attribute *attrs[] = {
	...
	&wireless_charge_attribute.attr,
	&cpu_attribute.attr,
