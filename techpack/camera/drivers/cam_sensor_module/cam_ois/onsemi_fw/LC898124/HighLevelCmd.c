...
//	SetTransDataAdr124( SinWave_OutAddr	,	(UINT32)SinWave_Output ) ;		// 初期値の出力先アドレスは、自分のメンバ
...
//	SetTransDataAdr124( CosWave_OutAddr	,	(UINT32)CosWave_Output );		// 初期値の出力先アドレスは、自分のメンバ
...
UINT8	RunGea124( void )
{
	...
	MesFil124( THROUGH ) ;				// 測定用フィルターを設定する。
